...
INSERT INTO
    public.account
    (id, name, uid, role_id, username, password, active)
VALUES
    (1, 'admin', 'admin', 1, 'admin', '$2y$10$FZSRqIGNKq64P3Rz27jlzuKuSZ9Rik9qHnqk5zH2Z7d67.erqaNhy', true);
...
INSERT INTO
    public.contentpage
    (id, name, entity_id, url)
VALUES
    (1, 'Homepage', 'contentpage', '/');
